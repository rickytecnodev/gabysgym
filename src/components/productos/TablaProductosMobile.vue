  ...
  <div>
    ...
    <div v-else class="gy-2">
      <div v-for="producto in productos" :key="producto.id">
        <div :class="['p-3 rounded-3 border bg-white mb-2 shadow-sm borde-izq-tarjeta', producto.estado === 'activo' ? 'borde-izq-verde' : 'borde-izq-gris']">
          ...
          <div class="mt-2 pt-2 border-top d-flex justify-content-between align-items-center">
            <div class="d-flex gap-1">
              ...
              <button v-if="isSuperadmin" @click="$emit('eliminar', producto.id)" class="btn btn-sm btn-outline-danger"
                title="Eliminar">
