    ...
    <div class="container-fluid py-4">
      ...
      <div v-if="showModalTipoMembresia" class="modal show d-block" tabindex="-1" style="background-color: rgba(0,0,0,0.5)">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">{{ tipoMembresiaEditando ? 'Editar' : 'Nuevo' }} Tipo de Membresía</h5>
              <button type="button" class="btn-close" @click="cerrarModalTipoMembresia"></button>
            </div>
            <div class="modal-body">
              <form @submit.prevent="guardarTipoMembresia">
                <div class="mb-3">
                  <label class="form-label">Nombre *</label>
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary" :disabled="loadingTipoMembresia">
...
const loadingTiposMembresia = ref(false);
